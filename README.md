...
STRIPE_PRICE_ID_ATHLETE=price_...
STRIPE_PRICE_ID_COACH_BASE=price_...
STRIPE_PRICE_ID_COACH_ADDITIONAL=price_...
# Optional: use payment mode instead of subscription.
