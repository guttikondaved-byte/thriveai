      ...
      <div className="relative z-10 w-full max-w-md bg-background border border-red-500/30 rounded-2xl shadow-2xl p-6">
        ...
        <label className="flex items-start gap-3 cursor-pointer mb-5 group">
          <input
            ...
            className="mt-0.5 w-4 h-4 rounded border-border bg-muted accent-red-500 cursor-pointer shrink-0"
          />
        ...
        <div className="flex gap-3">
          <button onClick={onClose} className="flex-1 py-2.5 rounded-xl border border-border text-muted-foreground hover:text-foreground text-sm font-medium transition-colors">
            Cancel
          </button>
          <button
...
function BillingCard({ userRole }: { userRole: string | null | undefined }) {
  ...
  const description = planType === "coach"
    ...
    : "$4.99/mo for unlimited AveraAI + voice input, auto Strava sync, unlimited plans, full activity history, the intensity map, what-if simulator, weekly summary email, and CSV export.";
      ...
      <div className="p-6 max-w-2xl mx-auto space-y-6">
        ...
        <div className="bg-background border border-border rounded-xl p-6">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary to-primary flex items-center justify-center text-xl font-bold text-foreground">
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <FormField control={form.control} name="name" render={({ field }) => (
                  <FormItem className="col-span-2">
                    ...
                    <FormControl>
                      <Input className="bg-background border-border text-foreground placeholder-muted-foreground" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
                <FormField control={form.control} name="age" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" className="bg-background border-border text-foreground placeholder-muted-foreground" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
              ...
              <FormField control={form.control} name="bio" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <textarea
                      className="w-full bg-background border border-border rounded-lg px-3 py-2 text-sm text-foreground placeholder-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary/50 focus:border-primary min-h-[80px] resize-y"
        ...
        <div className="rounded-xl border border-red-500/25 bg-red-500/5 p-5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg border border-red-500/40 text-red-600 hover:bg-red-500/10 hover:border-red-500/60 text-sm font-semibold transition-all"
          >
            <Trash2 size={14} />
            Delete account
          </button>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <FormField control={form.control} name="age" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Age <span className="text-red-600">*</span></FormLabel>
                  ...
                  <FormField control={form.control} name="fitnessLevel" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Fitness Level <span className="text-red-600">*</span></FormLabel>
                  ...
                  <FormField control={form.control} name="primaryGoal" render={({ field }) => (
                    <FormItem className="col-span-2">
                      <FormLabel>Primary Goal <span className="text-red-600">*</span></FormLabel>
                  ...
                  <FormField control={form.control} name="weeklyMileageGoal" render={({ field }) => (
                    <FormItem>
                      <FormLabel>Weekly Distance Goal (mi) <span className="text-red-600">*</span></FormLabel>
