...
function BillingCard({ userRole }: { userRole: string | null | undefined }) {
  ...
  const description = planType === "coach"
    ...
    : "$7.99/mo for unlimited AveraAI + voice input, auto Strava sync, unlimited plans, full activity history, the intensity map, what-if simulator, weekly summary email, and CSV export.";
