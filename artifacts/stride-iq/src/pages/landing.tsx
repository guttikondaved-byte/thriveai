...
const COACH_FEATURES = [
  ...
  },
  {
    ...
    desc: "Thrive flags any athlete spiking mileage faster than 10%/week.",
  },
  {
...
const h2 =
  "font-display font-bold leading-[1.08] tracking-[-0.02em] text-[#F5F5F5] mb-5";
        ...
        return (
          <div key={item.title} className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="text-[#8A9287] text-[15px] leading-[1.6] m-0">
                {item.desc}
              </p>
            </div>
          </div>
    ...
    <div className="bg-background overflow-x-clip">
      ...
      >
        <div className={cn(WRAP, "flex items-center justify-between h-[68px]")}>
          ...
          >
            ...
            />
            <span className="font-display font-extrabold text-[21px] tracking-[-0.02em] text-[#F5F5F5]">
              Thrive
            </span>
          </button>
      ...
      <section id="top" className="relative overflow-hidden bg-background">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 55% 60% at 78% 50%,rgba(42,80,76,0.20) 0%,transparent 64%)",
          }}
        />
          ...
          >
            <div className="w-full shrink-0 lg:w-[52%]">
              <div className="inline-flex items-center gap-[10px] bg-[#0C0F1A] border border-[#182220] rounded-full px-4 py-2 mb-7">
                <span className="text-[#3D7A74] tracking-[2px] text-[13px]">
                  ★★★★★
                </span>
                <span className="text-[#8A9287] text-[13px]">
                  Validated by 70+ athletes & coaches before launch
                </span>
              </div>
              <h1
                className="font-display font-extrabold leading-[1.04] tracking-[-0.03em] text-[#F5F5F5] mb-[22px]"
                style={{ fontSize: "clamp(40px,7vw,72px)" }}
              >
                Take your training
                <br />
                to the <span className="text-[#3D7A74]">next level</span>
              </h1>
              <p
                className="text-[#8A9287] leading-[1.65] max-w-[30rem] mb-8"
            ...
            <div className="w-full relative shrink-0 lg:w-[44%]">
              <div
                ...
                style={{ inset: "-10% -8%", background: "rgba(42,80,76,0.20)" }}
              />
              <div
                className="relative z-[1] rounded-[18px] border border-white/10 bg-[#0C0F1A] p-[10px]"
      ...
      <section
        id="athletes"
        className="relative overflow-hidden bg-[#0C0F1A] border-t border-[#182220]"
      >
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            background:
              "radial-gradient(ellipse 65% 50% at 50% 0%,rgba(42,80,76,0.20) 0%,transparent 70%)",
          }}
        />
        <div className={cn(WRAP, SEC, "relative")}>
          <div
          ...
          >
            <div className="flex-1">
              ...
              <p
                className="text-[#8A9287] leading-[1.65] max-w-[34rem] mb-[14px]"
                style={{ fontSize: "clamp(15px,1.6vw,18px)" }}
              >
            ...
            <div className="flex-1">
              ...
              >
                <div className="rounded-[14px] border border-[#182220] bg-[#0C0F1A] p-4">
                  <p className="font-mono text-[10px] tracking-[0.18em] uppercase text-[#8A9287] mb-[10px]">
                    This week
                  </p>
                  <div className="flex justify-between items-end">
                    <div>
                      <p className="font-display font-bold text-[26px] text-[#F5F5F5] m-0">
                        42.3 km
                      </p>
                      <p className="text-[#3D7A74] text-[13px] mt-1">
                        ↑ 12% vs last week
                      </p>
                    </div>
                ...
                <div className="rounded-[14px] border border-[#182220] bg-[#0C0F1A] p-4">
                  <div className="flex items-center justify-between">
                    <p className="text-sm font-medium text-[#F5F5F5] m-0">
                      Injury Risk
                    </p>
                ...
                <div className="rounded-[14px] border border-[#F2D2CF]/[22%] bg-[#F2D2CF]/[5%] p-4">
                  <p className="font-mono text-[10px] tracking-[0.18em] uppercase text-[#F2D2CF] mb-2">
                    AveraAI
                  </p>
                  <p className="text-sm leading-[1.6] text-[#F5F5F5] m-0">
      ...
      <section id="coaches" className="relative overflow-hidden bg-background">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 55% 45% at 95% 100%,rgba(242,210,207,0.10) 0%,transparent 65%)",
          }}
        />
        <div className={cn(WRAP, SEC, "relative")}>
          <div
          ...
          >
            <div className="flex-1">
              ...
              <p
                ...
                style={{ fontSize: "clamp(15px,1.6vw,18px)" }}
              >
                Thrive gives coaches the bird's-eye view they've never had:
                every athlete's weekly mileage, injury risk score, and training
                load in a single dashboard. Catch overtraining before it becomes
                a DNS. Scale from 5 athletes to 50 without losing the personal
                touch.
              </p>
            ...
            <div className="flex-1">
              <div
                className="rounded-[18px] border border-[#182220] bg-[#0C0F1A] overflow-hidden"
                style={{ boxShadow: "0 30px 60px -28px rgba(0,0,0,0.7)" }}
              >
                <div className="px-[18px] py-[14px] border-b border-[#182220] flex justify-between items-center">
                  <p className="text-sm font-semibold text-[#F5F5F5] m-0">
                    Team Overview
                  </p>
                  <p className="font-mono text-xs text-[#8A9287] m-0">
                    Week of Jun 23
                  </p>
                </div>
                <div
                  className="grid px-[18px] py-[10px] border-b border-[#182220]"
                  style={{ gridTemplateColumns: "1.4fr 1fr 0.9fr 1fr" }}
                >
                  {["Athlete", "Mileage", "Risk", "Load"].map((h) => (
                    <span
                      key={h}
                      className="font-mono text-[10px] tracking-[0.12em] uppercase text-[#8A9287]"
                    >
                      {h}
                    </span>
                  ))}
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      borderBottom:
                        i < arr.length - 1 ? "1px solid #182220" : "none",
      ...
      <section id="features" className="bg-[#0C0F1A] border-t border-[#182220]">
        <div className={cn(WRAP, SEC)}>
          ...
          <p
            className="text-[#8A9287] leading-[1.65] text-center max-w-[38rem] mx-auto mb-14"
            style={{ fontSize: "clamp(15px,1.6vw,18px)" }}
          >
          ...
          >
            {[
              ...
              >
                {card.content}
                <p className="text-sm text-[#8A9287] text-center m-0 px-[6px] leading-[1.55]">
                  {card.caption}
                </p>
              </div>
            ))}
      ...
      <section className="bg-background">
        <div className={cn(WRAP, SEC)}>
          <div className="flex flex-col lg:flex-row rounded-[18px] overflow-hidden">
            ...
            <div
              className="lg:w-[55%] bg-[#0C0F1A] flex flex-col justify-center"
              style={{ padding: "clamp(32px,4vw,56px)" }}
            >
              <div
                key={currentIndex}
                className="border-l-4 border-l-[#3D7A74] pl-6"
              >
                <p
                  className="text-[#F5F5F5] italic leading-[1.6] mb-[26px]"
      ...
      <section className="relative overflow-hidden bg-background border-t border-[#182220]">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 60% 45% at 12% 50%,rgba(42,80,76,0.16) 0%,transparent 64%)",
          }}
        />
        <div className={cn(WRAP, SEC, "relative")}>
          <div
      ...
      <section id="pricing" className="bg-background border-t border-[#182220]">
        <div className={cn(WRAP, SEC)}>
          ...
          <p
            className="text-[#8A9287] leading-[1.65] text-center"
            style={{ fontSize: "clamp(15px,1.6vw,18px)" }}
          >
          ...
          >
            <div
              className="flex flex-col bg-[#0C0F1A] rounded-[24px] border border-[#3D7A74]/30"
              style={{
                padding: "clamp(28px,3.2vw,42px)",
                boxShadow:
                  "0 0 60px -28px rgba(61,122,116,0.45),0 30px 60px -34px rgba(0,0,0,0.75)",
              }}
            >
              <p className={cn(eyebrow, "text-[#3D7A74] mb-[18px]")}>
                For Athletes
              </p>
              <div className="flex items-end gap-2 mb-[26px]">
                <span
                  className="font-display font-extrabold leading-none text-[#F5F5F5]"
            ...
            <div
              className="flex flex-col bg-[#0C0F1A] rounded-[24px] border border-[#F2D2CF]/[24%]"
              style={{
                padding: "clamp(28px,3.2vw,42px)",
                boxShadow:
                  "0 0 60px -30px rgba(242,210,207,0.30),0 30px 60px -34px rgba(0,0,0,0.75)",
              }}
            >
              <p className={cn(eyebrow, "text-[#F2D2CF] mb-[18px]")}>
                For Coaches
              </p>
              ...
              <p className="font-mono text-[13px] text-[#8A9287] mb-6">
            ...
            <div className="lg:w-[60%] flex-grow">
              {FAQ_ITEMS.map((item, i) => (
                <div key={i} className="border-t border-[#182220]">
                  ...
                  {openFaq === i && (
                    <p className="text-[#8A9287] text-[15px] leading-[1.65] m-0 pb-[22px] max-w-[46rem]">
                      {item.a}
                    </p>
                  )}
                </div>
      ...
      <section id="cta" className="relative overflow-hidden bg-[#0C0F1A]">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 50% 80% at 50% 120%,rgba(42,80,76,0.20) 0%,transparent 65%)",
          }}
        />
        <div className={cn(WRAP, SEC, "relative")}>
          <div
          ...
          >
            ...
            <div className="lg:w-[55%]">
              <h2
                className="font-display font-extrabold leading-[1.04] tracking-[-0.03em] text-[#F5F5F5] mb-6"
                style={{ fontSize: "clamp(34px,5.5vw,60px)" }}
              >
                Take your training to the{" "}
                <span className="text-[#3D7A74]">next level</span>
              </h2>
              <p
                className="text-[#8A9287] leading-[1.65] max-w-[30rem] mb-[30px]"
                style={{ fontSize: "clamp(15px,1.6vw,18px)" }}
              >
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between gap-9">
            <div className="max-w-[280px]">
              <div className="flex items-center gap-[10px] mb-[14px]">
                ...
                />
                <span className="font-display font-extrabold text-[19px] text-[#F5F5F5]">
                  Thrive
                </span>
              </div>
              <p className="text-[#8A9287] text-sm leading-[1.6] m-0">
                AI-powered training for runners and coaches.
              </p>
            </div>
            <div className="flex gap-16 flex-wrap">
              <div className="flex flex-col gap-3">
                <p className="font-mono text-[11px] tracking-[0.16em] uppercase text-[#8A9287] mb-1">
                  Product
                </p>
                {navLinks.map(([label, id]) => (
                  <button
...
function FeatureDashboardCard() {
  return (
    <FeatureCardShell>
      <p className="font-mono text-[10px] tracking-[0.16em] uppercase text-[#8A9287] m-0">
        Dashboard · Jun 25
      </p>
  ...
  return (
    <FeatureCardShell>
      <div className="flex items-center gap-2">
        ...
        <span className="text-xs text-[#3D7A74] font-medium">
          Long Run · 11 mi
        </span>
      </div>
      <p className="font-display font-bold text-[20px] text-[#F5F5F5] m-0">
        Tuesday Morning Run
      </p>
      <div className="grid grid-cols-2 gap-2 mt-2">
        {metrics.map(([label, val]) => (
          <div
            key={label}
            className="rounded-[10px] bg-[#0C0F1A] border border-[#182220] p-[9px]"
          >
            <p className="font-mono text-[9px] uppercase text-[#8A9287] m-0">
              {label}
            </p>
      ...
      <div className="mt-auto rounded-[12px] bg-[#0C0F1A] border border-[#F2D2CF]/[22%] p-3">
        <p className="font-mono text-[9px] tracking-[0.16em] uppercase text-[#F2D2CF] mb-[6px]">
          AveraAI insight
        </p>
        <p className="text-xs leading-[1.55] text-[#F5F5F5] m-0">
    ...
    <FeatureCardShell>
      ...
      <div className="flex flex-col gap-2 mt-0.5">
        {days.map(({ day, run, done }) => (
          ...
          >
            <span className="font-mono text-xs text-[#8A9287] w-[26px]">
              {day}
            </span>
