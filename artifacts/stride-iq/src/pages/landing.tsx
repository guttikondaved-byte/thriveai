        ...
        >
          ...
          >
            ...
            <p
              ...
              style={{ animation: "popup-fade-up 0.5s ease-out both", animationDelay: "1.7s" }}
            >
            ...
            <div className="mt-5">
              ...
              <div className="relative h-7 flex justify-start pl-3 overflow-visible">
                <img
                  ...
                  style={{ animation: "popup-bolt-bounce 1.3s cubic-bezier(0.45,0,0.2,1) both", animationDelay: "0.25s" }}
                />
              </div>
              <div className="flex items-center gap-2.5">
                <img
                  ...
                  style={{ animation: "popup-fade-up 0.4s ease-out both", animationDelay: "1.45s" }}
                />
                <div
