...
import CoachAthleteInjuryRisk from "@/pages/coach-athlete-injury-risk";
...
import DemoCoachAthleteInjuryRisk from "@/pages/demo-coach/athlete-injury-risk";
  ...
  return (
    <DemoCoachLayout>
      <Switch>
        ...
        <Route path="/demo-coach/athletes/:userId/injury-risk" component={DemoCoachAthleteInjuryRisk} />
  ...
  return (
    <CoachLayout>
      <Switch>
        ...
        <Route path="/athletes/:userId/injury-risk" component={CoachAthleteInjuryRisk} />
        <Route path="/team" component={Team} />
